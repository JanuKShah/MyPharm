...
public class ChooseOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animationDrawable.addFrame(getResources().getDrawable(R.drawable.metacin), 3000);
        animationDrawable.addFrame(getResources().getDrawable(R.drawable.azithromycin), 3000);
        animationDrawable.addFrame(getResources().getDrawable(R.drawable.dolo), 3000);
        animationDrawable.addFrame(getResources().getDrawable(R.drawable.dettol), 3000);
        animationDrawable.addFrame(getResources().getDrawable(R.drawable.paracetamol), 3000);
