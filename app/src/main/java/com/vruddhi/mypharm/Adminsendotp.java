...
import com.vruddhi.mypharm.R;
import com.vruddhi.mypharm.ReusableCode.ReusableCodeForAll;
        ...
        FAuth.signInWithCredential(credential)
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            //Intent intent=new Intent(Adminsendotp.this,AdminMedicinePanel_BottomNavigation.class);
